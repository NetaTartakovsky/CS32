...
public:
    ...
    Map(const Map& m);   // Copy constructor - makes a copy of the object that is passed by reference
...
private:
    ...
    struct Node   // Structure that holds a KeyType and a ValueType
    {
        KeyType m_key;
        ValueType m_value;
        Node *next = nullptr;
    ...
    int m_size;     // Amt of key/value pairs in the map
